...
def create_filters(
    ...
    if distance_min:
        filters.append(MinDistanceFilter(operator.ge, distance_min))
    if distance_max:
        filters.append(MaxDistanceFilter(operator.le, distance_max))
    if velocity_min:
        filters.append(MinVelocityFilter(operator.ge, velocity_min))
    if velocity_max:
        filters.append(MaxVelocityFilter(operator.le, velocity_max))
    if diameter_min:
